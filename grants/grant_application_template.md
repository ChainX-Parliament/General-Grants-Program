...
### Milestone 1 — Implement Substrate Modules — 1 month
* We will create a ... (Please list the functions that will be coded for the first milestone).
* We will deliver ...
...
### Milestone 2 — Additional features — 1 month 
